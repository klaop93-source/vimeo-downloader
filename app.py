...
def download_segments(base_url, track, label, progress_bar, status_text):
    ...
    try:
        # Using 5 workers to keep the stream fast without overloading the server
...
if url_input:
    ...
    with st.container():
        ...
        if st.button("🚀 Process & Download Video", use_container_width=True, type="primary"):
            ...
            # Download Video using Concurrent Threads
            ...
            if video_data:
                ...
                # Download Audio using Concurrent Threads
                if meta["audio"]:
                    ...
                    # Video has no audio track, just serve the video file
